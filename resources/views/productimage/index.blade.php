...
<div class="card" style="background: linear-gradient(to right, #6366F1, #3B82F6, #EC4899);">
    ...
    <div class="card-header">
      ...
      <a type="" href="{{ route('productdetails.index') }}" style="color:white;" class="btn bg-orange "><i class="fa fa-shopping-cart text-white"></i>Product Details</a>
        ...
        <div style="overflow-x:auto;">
            <table id="" class="table table-bordered" >
              ...
              <tbody class="text-white" style="">
                  ...
                  <tr>
                    <td><input type="checkbox" class="sub_chk" data-id="{{$productimage->id}}"></td>
                    
                      <td class="text-center">
                          {{ $productimage->product_id }}
                      </td>
                      <td class="text-center">
                          <img src="{{ Storage::url('public/productimages/').$productimage->image }}" class="rounded" style="width: 70px">
                      </td>
                      </td>
                      <td class="text-center">
                        {{ $productimage->title }}
                      ...
                      <td class="text-center">
                          <form action="{{ route('productimages.destroy', $productimage) }}" method="POST" id="delete-form">
                          {{-- <form data-confirm-delete="true" action="{{ route('products.destroy', $productimage->id) }}" method="POST"> --}}
                              <a href="{{ route('productdetails.show', $productimage->id) }}" class="btn btn-sm btn-info"><i class="fa fa-eye"></i></a>
                              <a href="{{ route('productimages.edit', $productimage->id) }}" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i></a>
                              <a data-url="{{ url('myproductimagesDeleteAll') }}" class="btn btn-sm delete_all" style="background-color: rgb(130, 0, 0);color:white;"><i class="fa fa-trash"></i></a>
